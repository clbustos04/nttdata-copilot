...
activities = {
    ...
    "Basketball Club": {
        "description": "Skill development, drills, and intramural games",
        "schedule": "Tuesdays and Fridays, 4:15 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["sophia.b@mergington.edu", "ethan@mergington.edu"]
    },
    # Artistic activities
    "Art Club": {
        "description": "Explore painting, drawing, sculpture, and gallery visits",
...
def unregister_from_activity(activity_name: str, email: str):
    """Unregister a student from a specific activity by email."""
    # Validate activity exists
    if activity_name not in activities:
        raise HTTPException(status_code=404, detail="Activity not found")
